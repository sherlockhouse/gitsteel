...
# freeme.biantao, 20161220. Insert $(FREEME_BOARD_SEPOLICY_DIRS)
build_policy = $(foreach type, $(1), $(foreach file, $(addsuffix /$(type), $(LOCAL_PATH) $(BOARD_SEPOLICY_DIRS) $(FREEME_BOARD_SEPOLICY_DIRS)), $(sort $(wildcard $(file)))))

# Builds paths for all policy files found in BOARD_SEPOLICY_DIRS.
# $(1): the set of policy name paths to build
# freeme.biantao, 20161220. Insert $(FREEME_BOARD_SEPOLICY_DIRS)
build_device_policy = $(foreach type, $(1), $(foreach file, $(addsuffix /$(type), $(BOARD_SEPOLICY_DIRS) $(FREEME_BOARD_SEPOLICY_DIRS)), $(sort $(wildcard $(file)))))
