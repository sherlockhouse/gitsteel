...
static const interop_addr_entry_t interop_addr_database[] = {
  ...
  {{{0x50,0xc9,0x71,       0,0,0}}, 3, INTEROP_DISABLE_SERVICE_SECURITY_CHECK},
  ...
  {{{0x00, 0x26, 0x7e,       0,0,0}}, 3, INTEROP_MTK_AV_CONNECT_DO_SDP_EVEN_FAIL},
   ...
   {{{0x00, 0x18, 0x13,       0,0,0}}, 3, INTEROP_MTK_A2DP_NOT_SET_SCMT},
   {{{0x00, 0x1E, 0xDC,       0,0,0}}, 3, INTEROP_MTK_A2DP_NOT_SET_SCMT},
   ...
   {{{0x11, 0x75, 0x58,       0,0,0}}, 3, INTEROP_MTK_PRIOR_ACCEPT_AVDTP_CONN},
