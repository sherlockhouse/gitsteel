...
/* Host support firmware log feature
 * Firmware will use controller debug event 0xff with sub opcode 0x50 to send
 * firmware log event to host.
 * Host will filter out this kind of events, and save them in a log file whose
 * name suffix is ".picus".
 */

#ifndef MTK_HOST_SUPPORT_FW_LOG
#define MTK_HOST_SUPPORT_FW_LOG           TRUE
#endif
...
#ifndef MTK_BTSNOOPLOG_LIMIT_MAX_LOG_COUNT
#define MTK_BTSNOOPLOG_LIMIT_MAX_LOG_COUNT TRUE
#endif
#endif
...
/******************************************************************************
 *
 * display hci data in main log
 *
 * ******************************************************************************/
#ifndef MTK_DISPLAY_HCI
#define MTK_DISPLAY_HCI TRUE
#endif
