...
#define BTA_AG_FEAT_HF_IND  0x00000400   /* HF indicator */
#define BTA_AG_FEAT_VOIP    0x00001000   /* VoIP call */
#define BTA_AG_FEAT_eSCO_S4 0x00000800   /* eSCO_S4 */
...
#define BTA_AG_AT_BIND_EVT      28 /* BIND */
#define BTA_AG_AT_BIEV_EVT      29 /* BIEV */
#endif
...
#if(MTK_HFP_HF_IND == TRUE)
/* HF indicator */
#define BTA_AG_IND_SAFETY             1   /*safety indicator */
#define BTA_AG_IND_HF_BATT            2   /*HF battery indicator */
#define NUM_OF_HF_IND                 2   /*Number of supported hf indicators*/
#endif
