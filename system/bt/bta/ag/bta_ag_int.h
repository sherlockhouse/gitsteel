...
#define BTA_AG_BSRF_FEAT_SPEC        (BTA_AG_FEAT_3WAY | BTA_AG_FEAT_ECNR    | \
                                      ...
                                      BTA_AG_FEAT_VOIP | BTA_AG_FEAT_eSCO_S4 | \
                                      BTA_AG_FEAT_HF_IND)
...
typedef struct
{
    ...
    BOOLEAN             safty_enabled;   /* set to TRUE if HF enables SAFTY reporting */
    BOOLEAN             hf_batt_enabled;   /* set to TRUE if HF enables HF_BATT reporting */
    BOOLEAN             safty_ind;    /* BIEV battery charge indicator value */
    UINT8               hf_batt_ind;    /* BIEV battery charge indicator value */
#endif
