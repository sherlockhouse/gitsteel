...
#if MTK_BTSNOOPLOG_THREAD == TRUE
#include "twrite.h"
#endif
#if MTK_DISPLAY_HCI == TRUE
...
#if MTK_DISPLAY_HCI == TRUE
  module_start_up(get_module(HCI_DATA_DUMP_MODULE));
#endif
...
#if MTK_DISPLAY_HCI == TRUE
  module_shut_down(get_module(HCI_DATA_DUMP_MODULE));
#endif
