...
enum {
    ...
    AUDIO_DEVICE_OUT_USB_PRIMARY               = 0x2000000,
    ...
    AUDIO_DEVICE_IN_SPK_FEED              = AUDIO_DEVICE_BIT_IN | 0x2000000, // Speaker Feedback (analog or digital)
    AUDIO_DEVICE_IN_MATV                  = AUDIO_DEVICE_BIT_IN | 0x8000000, // mATV (analog or digital)
    AUDIO_DEVICE_IN_TDM                   = AUDIO_DEVICE_BIT_IN | 0x10000000, // TDM (digital)
    AUDIO_DEVICE_IN_IP                    = AUDIO_DEVICE_BIT_IN | 0x80000,
    /* audio bus implemented by the audio system (e.g an MOST stereo channel) */
    AUDIO_DEVICE_IN_BUS                   = AUDIO_DEVICE_BIT_IN | 0x100000,
    AUDIO_DEVICE_IN_USB_PRIMARY           = AUDIO_DEVICE_BIT_IN | 0x200000,
    ...
    AUDIO_DEVICE_IN_ALL     = (AUDIO_DEVICE_IN_COMMUNICATION |
                               ...
                               AUDIO_DEVICE_IN_SPK_FEED |
                               AUDIO_DEVICE_IN_MATV |
                               AUDIO_DEVICE_IN_IP |
                               AUDIO_DEVICE_IN_BUS |
                               AUDIO_DEVICE_IN_USB_PRIMARY |
                               AUDIO_DEVICE_IN_DEFAULT),
...
//<MTK_AUDIO_ADD
    AUDIO_OUTPUT_FLAG_TO_REMOTE_SUBMIX = 0x800,
//MTK_AUDIO_ADD>
...
typedef enum {
    ...
    AUDIO_INPUT_FLAG_CROSSMOUNT = 0x80,
